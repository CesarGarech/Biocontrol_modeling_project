...
def lote_alimentado_page():
    ...
    with st.sidebar:
        ...
        tipo_mu = st.selectbox("Kinetic model", ["Simple Monod", "Sigmoidal Monod", "Monod with restrictions"])
        ...
        if estrategia == "Linear":
            F_lineal_fin = st.slider("Final Floow (Linear) [L/h]", F_base, 10.0, F_base * 2) # Asegura F_fin >= F_base
